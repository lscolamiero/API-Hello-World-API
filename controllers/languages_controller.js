    ...
    Language.insertMany([ 
        {
            ...
            "name": "spanish",
            "greeting": "Hola mundo",
            "pangram": "Benja pidiÃ³ una bebida de kiwi y fresa; NoÃ©, sin vergÃ¼enza, la mÃ¡s exquisita champaÃ±a del menÃº"
        },{
            "name": "korean",
            "greeting": "ì„¸ìƒì•„, ì•ˆë…•",
            "pangram": "ì›¬ ì´ˆì½œë¦¿? ê°€ ì›í–ˆë˜ ê±´ ë»¥íŠ€ê¸° ì¬ë”ê³¼ ì˜ë¥˜ì˜ˆìš”. ì–˜ì•¼, ì™œ ë˜ ë¶ˆí‰?"
        },{
            "name": "swedish",
